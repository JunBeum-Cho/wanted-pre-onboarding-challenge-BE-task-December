...
요즘 기업들은 데이터 분석과 재활용 측면에 있어서 많은 관심을 가지고 활용하고 있습니다.
<br>
하지만 이러한 대용량 데이터를 전송하다보면 서버에 부하가 심해 죽어버리거나 메시지 손실이 있을 수가 있는데요.
<br>
이러한 측면에서 MQ(Message Queue)를 매우 유용하게 활용할 수 있습니다.

로그를 처리하는 서비스(Consumer)를 분리하여 독립적으로 구성할 수 있고,
<br>
전달되는 메시지는 큐에 저장이 되고 순차적으로 받기 때문에 로그 처리 서비스는 자신의 처리량에 맞게 메시지를 가져와서 처리할 수 있습니다.
<br>
그리고 독립적인 확장을 통해 대용량 트래픽도 처리할 수도 있습니다.
